...
class NivelesControlador{
  public static function visualizarNivelesEmpleado(){
    $us = new Nivel();  // Creando una nueva instancia de la clase Usuario
    $listarDeCuanto = 5;$pagina = 1;
    $resultodoUsuarios = $us->seleccionarNiveles("",false,false);
    ...
    $resul = $us->seleccionarNiveles("",$inicioList,$listarDeCuanto);
    require("vista/nivelEmpleado/servidor/nivel_empleado.php");
  }

  public static function registrarNivelEmpleado($a){
    $us = new Nivel();  // Creando una nueva instancia de la clase Usuario
  ...
  public static function BuscarNivelEmpleadoNuevo($pagina, $listarDeCuanto, $buscar){
    $us = new Nivel();  // Creando una nueva instancia de la clase Normativa

    // Realizar la primera consulta para obtener el total de filas
    $resultodoUsuarios = $us->seleccionarNiveles($buscar, false, false);
    $num_filas_total = mysqli_num_rows($resultodoUsuarios);
    ...
    $resul = $us->seleccionarNiveles($buscar, $inicioList, $listarDeCuanto);
