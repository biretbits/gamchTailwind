...
<div class="content">
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row items-center py-4 text-white">
      <h5 class="text-lg font-semibold">DOCUMENTOS DE LA GACETA MUNICIPAL</h5>
    </div>
        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center">
          <div class="relative w-full max-w-2xl bg-white rounded-lg shadow-lg">
            ...
            <div class="flex justify-between items-center p-4 border-b">
              <h6 class="text-gray-700 font-semibold" id="miModalRegistro">DOCUMENTOS</h6>
            ...
            <div class="p-4">
              <div class="space-y-4">
                <form>
                  ...
                  <div class="mb-4">
                    <input type="hidden" class="w-full px-4 py-2 border rounded-md" id="ruta" name="ruta" placeholder="">
                  </div>

                  <div class="mb-4">
                    <input type="text" class="w-full px-4 py-2 border rounded-md" id="cod" name="cod" placeholder="Ponga código documento" required>
                  </div>

                  <div class="mb-4">
                    <input type="text" class="w-full px-4 py-2 border rounded-md" id="entidad" name="entidad" placeholder="Ponga entidad (Opcional)">
                  </div>
                  ...
                  <div class="mb-4">
                    <input type="text" class="w-full px-4 py-2 border rounded-md" id="dato_documento" name="dato_documento" placeholder="Ponga datos del documento (Opcional)">
                  </div>
