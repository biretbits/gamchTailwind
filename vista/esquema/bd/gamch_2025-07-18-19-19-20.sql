...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(4,28,'TECNICO AUXILIAR DEL CANAL MUNICIPAL','2025-07-18 00:00:00','2025-07-18 11:22:37','activo');
...
CREATE TABLE `clases` (
  ...
  `actualizado_en` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `documentos` (
  ...
  `datos_documento` varchar(255) DEFAULT NULL,
...
(3,28,4,'normal','Franz','Mamani','Mamani','Masculino','calle oruro',63642087,'franz@gmail.com',NULL,'2025-07-18 11:31:14','2025-07-18 11:31:14','activo');
...
CREATE TABLE `niveles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(3,3,3,'2025-07-18 15:17:32','2025-07-18 15:17:32');
...
CREATE TABLE `roles` (
  ...
  `creado_en` timestamp NULL DEFAULT current_timestamp(),
  `actualizado_en` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `especial` enum('acceso-total','sin-acceso') DEFAULT 'sin-acceso',
  PRIMARY KEY (`id`),
...
(3,3,'franz','$2y$12$pXZjoxhCj.g9fnI3mXno8er4/3L/gZWUq.1BYqIiyXXsHkF9svkE6','activo',NULL,'2025-07-18 15:17:02','2025-07-18 15:17:02');
SET FOREIGN_KEY_CHECKS = 1;
-- Se exporta la base de datos correctame