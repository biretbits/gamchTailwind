...
CREATE TABLE `cargos` (
  ...
  `cargo_empleado` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `estado` char(15) COLLATE utf8mb4_general_ci DEFAULT 'activo',
  PRIMARY KEY (`id`),
...
CREATE TABLE `clases` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_clase` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `consultas` (
  ...
  `consulta` text COLLATE utf8mb4_general_ci,
  `respuesta_consulta` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `cultura` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_actividad` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_actividad` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `enlace_web` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `documentos` (
  ...
  `cod` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `nombre_documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `datos_documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `publicar` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cod` (`cod`),
...
CREATE TABLE `empleados` (
  ...
  `tipo_empleado` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `nombre` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(1,6,1,'normal','Limbert','Lipiri','Villca','Masculino','Calle La Paz entre Linarez',63260832,'lipiri12345678xp@gmail.com','vista/activos/FotoUsuario/11637c65a09ff090279a0bce3a7bb3ca.jpg','2025-06-30 20:50:54','2025-06-30 21:57:54','activo');
...
CREATE TABLE `niveles` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nivel_empleado` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `estado` char(10) COLLATE utf8mb4_general_ci DEFAULT 'activo',
  PRIMARY KEY (`id`)
...
CREATE TABLE `nuevas_paginas` (
  ...
  `contenido` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `foto` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `fecha` date NOT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `roles` (
  ...
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `especial` enum('acceso-total','sin-acceso') COLLATE utf8mb4_general_ci DEFAULT 'sin-acceso',
  PRIMARY KEY (`id`),
...
CREATE TABLE `salarios` (
  ...
  `nivel_sueldo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `denominacion` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `turismo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_destino` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_destino` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `actividades_disponibles` text COLLATE utf8mb4_general_ci NOT NULL,
  `ubicacion` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `contacto` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `enlace_web` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `imagen_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
','Campo','Paseo en Botes.','Se Ubica a 10 km de la ciudad de Challapata.',60103030,NULL,'vista/activos/turismoImagen/d3ef05d9e8ead2f6ae55bb2fb06a7dff.jpg','2025-07-04 20:01:26','2025-07-04 20:01:26');
...
CREATE TABLE `usuarios` (
  ...
  `estado` char(15) COLLATE utf8mb4_general_ci DEFAULT 'activo',
  `token_recordar` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
