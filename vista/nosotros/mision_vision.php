...
<section class="min-h-screen flex items-center justify-center bg-red px-4 py-8 "  style="font-family: "Homer Simpson UI";background-image: url('imagenes/fondo/fondo3.svg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
