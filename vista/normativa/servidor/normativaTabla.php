...
<div class="content">
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row items-center py-4 text-black">
      <h5 class="text-lg font-semibold">DOCUMENTOS NORMATIVAS</h5>
    </div>
  ...
  <div class="flex items-center justify-center min-h-screen p-4 text-center">
    <div class="relative w-full max-w-2xl bg-white rounded-lg shadow-lg">
      ...
      <div class="flex justify-between items-center p-4 border-b">
        <h6 class="text-gray-700 font-semibold" id="miModalRegistro">DOCUMENTO NORMATIVAS</h6>
      ...
      <div class="p-4">
        <div class="space-y-4">
          <form>
            ...
            <div class="mb-4">
              <input type="text" class="form-input w-full px-4 py-2 border rounded-md" id="nombre_documento" name="nombre_documento" placeholder="Ponga nombre del Documento" required>
            </div>
            <div class="mb-4">
              <select class="form-select w-full px-4 py-2 border rounded-md" name="categoria" id="categoria" required>
            ...
            <div class="mb-4">
              <input type="text" class="form-input w-full px-4 py-2 border rounded-md" id="cod" name="cod" placeholder="Ponga codigo documento" required>
            </div>
            <div class="mb-4">
              <input type="text" class="form-input w-full px-4 py-2 border rounded-md" id="descripcion" name="descripcion" placeholder="Ponga descripción" required>
            </div>
            <div class="mb-4">
              <input type="file" accept="application/pdf" class="form-input w-full px-4 py-2 border rounded-md" id="archivo" name="archivo">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              <select class="form-select w-full px-4 py-2 border rounded-md" name="estado" id="estado" required>
            ...
            <div class="mb-4">
              <select class="form-select w-full px-4 py-2 border rounded-md" name="publicar" id="publicar" required>
            ...
            <tbody>
              ...
              if ($resul && mysqli_num_rows($resul) > 0) {
                ...
                while($fi = mysqli_fetch_array($resul)){
                  ...
                  $publica = $fi["publicar"];
                  echo "<td class='px-4 py-2 border'>".($publica == 1 ? "Sí" : "No")."</td>";
                  ...
                  echo "<td class='px-4 py-2 border'>
                    <div class='flex gap-2'>
                      ...
                      <button type='button' class='btn btn-danger py-1 px-3 bg-red-500 text-white rounded-md shadow-sm' title='Eliminar' onclick='accionBtnActivarDesactivar(1, ".$fi["id"].")'>
