...
<div class="content">
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row items-center py-4 text-black">
      <h5 class="text-lg font-semibold">NIVEL DE EMPLEADOS</h5>
    </div>
  ...
  <div class="flex items-center justify-center min-h-screen p-4 text-center">
    <div class="relative w-full max-w-2xl bg-white rounded-lg shadow-lg">
      ...
      <div class="flex justify-between items-center p-4 border-b">
        <h6 class="text-gray-700 font-semibold" id="miModalRegistro">NIVEL EMPLEADO</h6>
      ...
      <div class="p-4">
        <div class="space-y-4">
          <form>
            ...
            <div class="mb-4">
              <label for="nivel" class="text-sm font-semibold">Nombre de Nivel</label>
              <input type="text" class="form-input w-full px-4 py-2 border rounded-md" id="nivel" name="nivel" style="text-transform: uppercase;"
              oninput="this.value = this.value.toUpperCase();" placeholder="Ponga nombre de nivel" required>
            </div>
            <div class="mb-4">
            ...
            <tbody>
              ...
              if ($resul && mysqli_num_rows($resul) > 0) {
                ...
                while($fi = mysqli_fetch_array($resul)){
                  ...
                  $datos = [
                    "id" => $fi["id"],
                    "nivel_empleado" => addslashes($fi["nivel_empleado"]),
...
function BuscarUsuarios(page){
 ...
 function accionBtnEditar(data) {
   ...
   document.getElementById('nivel').value = data.nivel_empleado;
   ...
   function registrar(){
     ...
     var fecha_creacion = document.getElementById("fecha_creacion").value;
      registrarDatos(id,nivel,fecha_creacion);
   }

   function registrarDatos(id,nivel,fecha_creacion){
     var datos = new FormData(); // Crear un objeto FormData vacío
